...
export const TIMELINE = [
  ...
  },
  {
    ...
    consequence: 'Compressor isolated and depressured. Plant availability dropped 12.1%. Recycle gas flow to hydrocracker lost -- standby compressor picking up duty but slowly, causing temporary throughput reduction. Downstream cascade: V-501 saw pressure transient to 161 bar (EVT-006), C-201 fan belt shifted from piping transient (EVT-007). Two emergency work orders and two investigations opened immediately.',
