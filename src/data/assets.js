...
// Each event has full metadata: cause, consequence, recommendation, sub-asset linkage.
...
export const TIMELINE = [
  ...
  },
  {
    ...
    status: 'confirmed',
    cause: 'Drive end bearing journal surfaces have degraded from 14 days of contaminated lubrication. Shaft running eccentric as bearing clearances exceeded tolerance. Oil film thickness collapsed to 18 microns (alarm 25 microns). Bearing temperature at 108C (alarm 95C). Vibration alerts were present in the system for 3 days prior to this spike -- vibration had been climbing from 2.8 mm/s on day 14 through 5.1 mm/s on day 25 -- but no intervention was taken.',
    consequence: 'Vibration at 7.8 mm/s exceeds the 7.1 mm/s trip threshold. Automatic compressor trip will fire within seconds. This is now a protection system response, not an operator decision. Continued operation past this point risks catastrophic bearing failure, shaft seizure, and potential seal damage. The 3-day window where vibration alerts went unaddressed is the core failure this event exposes.',
    recommendation: 'Do not attempt to override the protection system. Prepare for automatic trip. Alert downstream operations (hydrocracker, V-501) for pressure transient. After trip, this event becomes the central evidence in the root cause investigation -- why were vibration alerts present for 3 days with no response?',
    kpiImpact: null,
    linkedWOs: [],
    linkedInvestigations: [],
  },
...
export const WORK_ORDERS = [
  ...
  { id: 'WO-4485', assetId: 'P-102', asset: 'Pump P-102', task: 'Quarterly vibration baseline measurement', urgency: 'scheduled', assignee: 'James Park', status: 'in-progress', created: 'Yesterday' },
  { id: 'WO-4486', assetId: 'V-501', asset: 'Vessel V-501', task: 'Pressure relief valve test and recertification', urgency: 'scheduled', assignee: 'Sarah Chen', status: 'open', created: 'Yesterday' },
  { id: 'WO-4487', assetId: 'E-105', asset: 'Heat Exchanger E-105', task: 'Tube bundle fouling assessment', urgency: 'scheduled', assignee: null, status: 'open', created: '2 days ago' },
  { id: 'WO-4488', assetId: 'T-102', asset: 'Turbine T-102', task: 'Borescope inspection preparation', urgency: 'scheduled', assignee: 'Mike Torres', status: 'open', created: '2 days ago' },
  { id: 'WO-4489', assetId: 'R-301', asset: 'Reactor R-301', task: 'Catalyst bed thermocouple calibration', urgency: 'scheduled', assignee: null, status: 'open', created: '3 days ago' },
  { id: 'WO-4490', assetId: 'K-302', asset: 'Compressor K-302', task: 'Discharge temperature sensor replacement', urgency: 'scheduled', assignee: 'Fred Martinez', status: 'open', created: '3 days ago' },
  { id: 'WO-4491', assetId: 'P-102', asset: 'Pump P-102', task: 'Coupling alignment check', urgency: 'scheduled', assignee: null, status: 'open', created: '4 days ago' },
  { id: 'WO-4492', assetId: 'E-105', asset: 'Heat Exchanger E-105', task: 'Shell-side UT thickness survey', urgency: 'scheduled', assignee: null, status: 'open', created: '4 days ago' },
  { id: 'WO-4493', assetId: 'V-501', asset: 'Vessel V-501', task: 'Level transmitter recalibration', urgency: 'scheduled', assignee: 'James Park', status: 'open', created: '5 days ago' },
  { id: 'WO-4494', assetId: 'K-302', asset: 'Compressor K-302', task: 'Anti-surge valve stroke test', urgency: 'scheduled', assignee: null, status: 'open', created: '5 days ago' },
  { id: 'WO-4495', assetId: 'T-102', asset: 'Turbine T-102', task: 'Exhaust temperature profile review', urgency: 'scheduled', assignee: null, status: 'open', created: '6 days ago' },
  { id: 'WO-4496', assetId: 'P-203', asset: 'Pump P-203', task: 'Suction strainer cleaning', urgency: 'scheduled', assignee: null, status: 'open', created: '1 week ago' },
  { id: 'WO-4497', assetId: 'R-301', asset: 'Reactor R-301', task: 'Hydrogen analyzer calibration', urgency: 'scheduled', assignee: 'Sarah Chen', status: 'open', created: '1 week ago' },
  { id: 'WO-4498', assetId: 'C-201', asset: 'Cooler C-201', task: 'Fan belt tension check', urgency: 'scheduled', assignee: null, status: 'open', created: '1 week ago' },
  { id: 'WO-4499', assetId: 'E-105', asset: 'Heat Exchanger E-105', task: 'Gasket inventory verification', urgency: 'scheduled', assignee: null, status: 'open', created: '1 week ago' },
  { id: 'WO-4500', assetId: 'K-302', asset: 'Compressor K-302', task: 'Lube oil sample and analysis', urgency: 'scheduled', assignee: 'Fred Martinez', status: 'open', created: '1 week ago' },
  { id: 'WO-4501', assetId: 'T-401', asset: 'Turbine T-401', task: 'Inlet air filter differential pressure check', urgency: 'scheduled', assignee: null, status: 'open', created: '2 weeks ago' },
  { id: 'WO-4502', assetId: 'V-501', asset: 'Vessel V-501', task: 'Corrosion coupon retrieval and analysis', urgency: 'scheduled', assignee: null, status: 'open', created: '2 weeks ago' },
  { id: 'WO-4503', assetId: 'P-102', asset: 'Pump P-102', task: 'Motor insulation resistance test', urgency: 'scheduled', assignee: null, status: 'open', created: '2 weeks ago' },
  { id: 'WO-4504', assetId: 'R-301', asset: 'Reactor R-301', task: 'Safety valve inspection scheduling', urgency: 'scheduled', assignee: null, status: 'open', created: '2 weeks ago' },
  { id: 'WO-4505', assetId: 'K-101', asset: 'Compressor K-101', task: 'Vibration probe gap voltage verification', urgency: 'scheduled', assignee: null, status: 'open', created: '3 weeks ago' },
]
